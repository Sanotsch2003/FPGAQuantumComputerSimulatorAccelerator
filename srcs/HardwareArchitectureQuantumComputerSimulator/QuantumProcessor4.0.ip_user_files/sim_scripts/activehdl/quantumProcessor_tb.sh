...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Jonas/Nextcloud/JugendForscht/SimulationVonQuantencomputern/Code/Versions/QuantumProcessor4.0/QuantumProcessor4.0.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
