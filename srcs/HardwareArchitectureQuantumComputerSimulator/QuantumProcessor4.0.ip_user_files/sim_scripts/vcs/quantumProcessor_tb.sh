...
#
# Script generated by Vivado on Sun Mar 17 19:15:27 +0100 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : quantumProcessor_tb.sh
...
#
# Usage        : quantumProcessor_tb.sh
#                quantumProcessor_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                quantumProcessor_tb.sh [-reset_run]
#                quantumProcessor_tb.sh [-reset_log]
#                quantumProcessor_tb.sh [-help]
#
...
#                script (type 'quantumProcessor_tb.sh -help' for more information).
#
...
# script info
echo -e "quantumProcessor_tb.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./quantumProcessor_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../QuantumProcessor4.0.gen/sources_1/ip/clockGenerator" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../QuantumProcessor4.0.gen/sources_1/ip/clockGenerator" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.quantumProcessor_tb xil_defaultlib.glbl -o quantumProcessor_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./quantumProcessor_tb_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key quantumProcessor_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc quantumProcessor_tb_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./quantumProcessor_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: quantumProcessor_tb.sh [-help]\n\
Usage: quantumProcessor_tb.sh [-step]\n\
Usage: quantumProcessor_tb.sh [-lib_map_path]\n\
Usage: quantumProcessor_tb.sh [-reset_run]\n\
Usage: quantumProcessor_tb.sh [-reset_log]\n\
Usage: quantumProcessor_tb.sh [-keep_index]\n\
Usage: quantumProcessor_tb.sh [-noclean_files]\n\n\
