...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../QuantumProcessor4.0.gen/sources_1/ip/clockGenerator" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../QuantumProcessor4.0.gen/sources_1/ip/clockGenerator" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.quantumProcessor_tb xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.quantumProcessor_tb -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log quantumProcessor_tb_sc.so .tmp_log xcelium_lib waves.shm c.obj)
