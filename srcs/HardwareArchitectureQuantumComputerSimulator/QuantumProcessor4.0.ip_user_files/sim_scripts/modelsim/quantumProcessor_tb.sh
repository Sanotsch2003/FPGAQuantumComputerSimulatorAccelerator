...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Jonas/Nextcloud/JugendForscht/SimulationVonQuantencomputern/Code/Versions/QuantumProcessor4.0/QuantumProcessor4.0.cache/compile_simlib/modelsim"
  fi
